...
import models.FlashcardsTable
import models.StatisticsTable
...
import routes.flashcardRoutes
import routes.statisticsRoutes
import routes.subjectRoutes
import java.io.File

fun main() {
    embeddedServer(Netty, port = System.getenv("PORT")?.toInt() ?: 9090, host = "0.0.0.0") {
        module()
    }.start(wait = true)
}
